document.addEventListener('DOMContentLoaded', () => {
    ...
    document.getElementsByClassName('home')[0].classList.add('liactive');
    document.getElementsByClassName('sub-btn')[0].style.opacity = '0.4';
    document.getElementsByClassName('sub-btn')[0].disabled = true;   // opacity of submit button
    ...
    document.getElementById('title').addEventListener('input', function (e) {
        if (e.data == null || document.getElementById('title').value == '') {
            ...
            document.getElementsByClassName('sub-btn')[0].disabled = false; 
        }
    })
    ...
    document.getElementsByClassName('addtoli')[0].addEventListener('click', function () {
        ...
        document.getElementsByClassName('home')[0].classList.remove('liactive');
    ...
    function notask() {
        ...
        if (truetodo.length === 0) {
            ...
            document.getElementsByClassName('search')[0].disabled =true;
    ...
    form.addEventListener('submit', function (e) {
        ...
        if ([titlee, due_date, category].includes('')) { alert(" * fields required"); return; }
            ...
            document.getElementsByClassName('search')[0].disabled =false;
    ...
    clear_btn[0].addEventListener('click', function () {
                ...
                document.getElementsByClassName('confirm-btn-delete')[0].addEventListener('click',function(){
                    counttotal();
                    localStorage.removeItem('todos');
                    window.location.reload();
                   
                })
                document.getElementsByClassName('cancel-btn-delete')[0].addEventListener('click',function(){
    ...
    document.getElementById('sort').addEventListener('click', function () {
        ...
        if (sortType == 'AZ') {
            sortedArray = newarray.slice().sort((a, b) => a.title.localeCompare(b.title))
            if (todobtn[0].classList.contains('active')) {
            ...
            sortedArray = newarray.slice().sort((a, b) => b.title.localeCompare(a.title))
            if (todobtn[0].classList.contains('active')) {
                DisplayTodos(sortedArray);
                return;
            }
            ...
            sortedArray = newarray.slice().sort((a, b) => new Date(b.due_date) - new Date(a.due_date));
            ...
            sortedArray = newarray.slice().sort((a, b) => new Date(a.due_date) - new Date(b.due_date));
    ...
    document.getElementsByClassName('profi')[0].addEventListener('click',function(){
       if(y){
